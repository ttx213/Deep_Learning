...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/home/wangtao/video_caption/Few_surpervised_vedio_captioning/video_captioning/dataset/vatex/few_supervision/dataset.json', help='input json file to process into hdf5')

    parser.add_argument('--output_dir', default='/home/wangtao/video_caption/Few_surpervised_vedio_captioning/video_captioning/dataset/vatex/few_supervision/', help='output directory')
