...
__all__ = ["VatexClipDataset"]

@DATASETS_REGISTRY.register() #调用自定义函数
class VatexClipDataset:
    @configurable
    def __init__(
        self,
        stage: str,
    ...
    def from_config(cls, cfg, stage: str = "train"):
        ann_files = {
            "train": os.path.join(cfg.DATALOADER.ANNO_FOLDER, "vatex_caption_anno_clipfilter_train.pkl"),
            "val": os.path.join(cfg.DATALOADER.ANNO_FOLDER, "vatex_caption_anno_clipfilter_val.pkl"),
            "test": os.path.join(cfg.DATALOADER.ANNO_FOLDER, "vatex_caption_anno_clipfilter_test.pkl")
        }
        ret = {
            "stage": stage,
