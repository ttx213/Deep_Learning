# -*- coding: utf-8 -*-
"""
From original at https://github.com/facebookresearch/detectron2/blob/master/detectron2/engine/hooks.py
...
class IterationTimer(HookBase):
    ...
    def after_step(self):
        ...
        # but not yet counted
        iter_done = self.trainer.iter - self.trainer.start_iter + 1 #1
...
class EvalHook(HookBase):
    ...
    def __init__(self, eval_period, eval_start, eval_function, iters_per_epoch, stage, multi_gpu_eval):
        ...
        """
        self._period = eval_period * iters_per_epoch #276
        self._func = eval_function
        self._stage = stage #'val' 'test'
        self._eval_start = eval_start #-1
        self._multi_gpu_eval = multi_gpu_eval #'False'
    ...
    def after_step(self):
        next_iter = self.trainer.iter + 1 #1
        epoch = int(next_iter // self.trainer.iters_per_epoch) #0
