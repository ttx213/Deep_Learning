...
from ..mtl_roberta import AutoTokenizer, PreTrainedTokenizer, PretrainedConfig, \
    SquadExample, squad_convert_examples_to_features, is_tf_available, is_torch_available, logger

if is_tf_available():
    from ..mtl_roberta import TFAutoModel, TFAutoModelForSequenceClassification, \
        TFAutoModelForQuestionAnswering, TFAutoModelForTokenClassification

if is_torch_available():
    import torch
    from ..mtl_roberta import AutoModel, AutoModelForSequenceClassification, \
...
class Pipeline(_ScikitCompat):
    ...
    def transform(self, X):
        """
        Scikit / Keras interface to mtl_transformers' pipelines. This method will forward to __call__().
        """
        return self(X=X)
