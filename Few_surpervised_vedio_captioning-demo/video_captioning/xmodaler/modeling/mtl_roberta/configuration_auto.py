...
class AutoConfig(object):
    r""":class:`~mtl_transformers.AutoConfig` is a generic configuration class
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        Params:
            pretrained_model_name_or_path: either:
                ...
                - a path to a `directory` containing a configuration file saved using the :func:`~mtl_transformers.PretrainedConfig.save_pretrained` method, e.g.: ``./my_model_directory/``.
