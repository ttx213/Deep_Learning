...
class AutoTokenizer(object):
    r""":class:`~mtl_transformers.AutoTokenizer` is a generic tokenizer class
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        Params:
            pretrained_model_name_or_path: either:
                ...
                - a path to a `directory` containing vocabulary files required by the tokenizer, for instance saved using the :func:`~mtl_transformers.PreTrainedTokenizer.save_pretrained` method, e.g.: ``./my_model_directory/``.
            ...
            kwargs: (`optional`) keyword arguments: will be passed to the Tokenizer ``__init__`` method. Can be used to set special tokens like ``bos_token``, ``eos_token``, ``unk_token``, ``sep_token``, ``pad_token``, ``cls_token``, ``mask_token``, ``additional_special_tokens``. See parameters in the doc string of :class:`~mtl_transformers.PreTrainedTokenizer` for details.
