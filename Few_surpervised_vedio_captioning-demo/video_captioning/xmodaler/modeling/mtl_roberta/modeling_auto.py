...
class AutoModel(object):
    r"""
        :class:`~mtl_transformers.AutoModel` is a generic model class
...
class AutoModelWithLMHead(object):
    r"""
        :class:`~mtl_transformers.AutoModelWithLMHead` is a generic model class
...
class AutoModelForSequenceClassification(object):
    r"""
        :class:`~mtl_transformers.AutoModelForSequenceClassification` is a generic model class
...
class AutoModelForQuestionAnswering(object):
    r"""
        :class:`~mtl_transformers.AutoModelForQuestionAnswering` is a generic model class
