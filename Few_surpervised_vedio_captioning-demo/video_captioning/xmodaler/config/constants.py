...
_K.POSITION_EMBED = 'POSITION_EMBED'

_K.ATT_OUTS = 'ATT_OUTS'

_K.CAND_INPS_SENTS = 'CAND_INPS_SENTS'

_K.G_OBJECT_IDS = 'G_OBJECT_IDS'

_K.G_SOFT_TARGET_IDS = 'G_SOFT_TARGET_IDS'

_K.VOCAB_IDS = 'VOCAB_IDS'

_K.VOCAB_PROBS = 'VOCAB_PROBS'

_K.FILLMASKS = 'FILLMASKS'
...
_K.MOTION_ATT_FEATS = 'MOTION_ATT_FEATS'

_K.OBJECT_ATT_FEATS = 'OBJECT_ATT_FEATS'

_K.ATT_FEATS_WO_MASK = 'ATT_FEATS_WO_MASK'

_K.ATT_MASKS = 'ATT_MASKS'

_K.OBJECT_ATT_MASKS = 'OBJECT_ATT_MASKS'

_K.EXT_ATT_MASKS = 'EXT_ATT_MASKS'

_K.EXT_object_ATT_MASKS = 'EXT_object_ATT_MASKS'
...
_K.COCO_PATH = '/home/wangtao/video_caption/xmodaler-master/xmodaler/coco-caption'

_K.TEMP_DIR = '/home/wangtao/video_caption/xmodaler-master/data/temp'
