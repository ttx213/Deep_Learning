...
class Vocab(object):
    def __init__(self, training_files=None, vocab_size=None):
        ...
        self.vocab_size =  len(self.token_to_id) #50003
        self.unk_token_id = self.token_to_id['<UNK>'] #50000
        self.bos_token_id = self.token_to_id['<BOS>'] #50001
        self.eos_token_id = self.token_to_id['<EOS>'] #50002
